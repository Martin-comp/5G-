window.DIGITAL_TEXTBOOK_OVERALL = {
  meta: {
    version: "overall-0.5-clean-preview",
    title: "5G网络优化教材（高级）",
    subtitle: "数字教材整书预览",
    stage: "项目任务导学 · 课程能力图谱 · 任务级学习样章",
    boundary: "从整书项目链进入项目、任务和学习活动。本预览以项目四“5G网络优化结果验证”展示完整学习闭环，并保留项目二“5G网络测试”到项目四“端到端网络优化”的关联路径。",
  ...
  courseStatus: [
    ...
    { label: "重点路径", value: "2", note: "网络测试、端到端优化" },
    { label: "完整任务", value: "1", note: "P4-T2优化结果验证" },
    { label: "能力主链", value: "7", note: "贯穿资源、活动和评价" }
  ],
  platformSupport: [
    {
      id: "task-resource-mapping",
      title: "任务资源映射",
      summary: "查看任务资源卡片如何挂接能力节点、学习活动和评价产出。",
      role: "教材呈现端辅助信息",
      boundary: "只解释当前教材任务所需资源，不作为学生学习主路径。"
    },
    {
      id: "material-platform",
      title: "素材子平台说明",
      summary: "素材入库、媒体审查、资源包封装、版本追溯在后台完成。",
      role: "素材/生产/交付子平台边界",
      boundary: "当前为设计说明，不表示后台系统已经真实开发完成。"
    },
    {
      id: "delivery-note",
      title: "交付说明",
      summary: "说明资源输出和直接呈现两条交付路线如何保留。",
      role: "出版和平台挂接说明",
      boundary: "不进入学生学习路径，不替代出版社平台接口。"
    }
  ],
  aiTeacherSuggestions: [
    {
      id: "AI-P4T2-ORG-01",
      taskId: "P4-T2",
      ...
      title: "任务组织建议",
      sourceInputs: ["P4-T2任务局部图谱", "资源卡片映射", "模拟学情"],
      suggestion: "先用投诉场景引出验证问题，再组织指标判断、依据分类和结论表达。",
      teacherAction: "审核确认或按班级基础调整",
      output: "两课时任务组织方案"
    },
    {
      ...
      title: "课堂讲评建议",
      sourceInputs: ["五个递进案例", "模拟错误分布", "学生修正句"],
      suggestion: "优先讲评平均值与95分位、通过依据与边界、四段式职业表达。",
      teacherAction: "选择本班最突出的两类错误进行讲评",
      output: "课堂讲评脚本"
    },
    {
      id: "AI-P4T2-CHECK-01",
      ...
      status: "generated_pending_confirm",
      title: "专业复核建议",
      sourceInputs: ["指标阈值", "案例结论", "待复核清单"],
      suggestion: "案例阈值和结论口径必须由通信专业教师或行业专家复核后才能进入正式发布。",
      teacherAction: "确认哪些口径可课堂使用，哪些必须标注待复核",
      output: "专业复核清单"
    }
  ],
  taskLocalGraph: {
    "P4-T2": {
      title: "P4-T2任务局部图谱",
      nodeIds: ["P4T2-N01", "P4T2-N02", "P4T2-N03", "P4T2-N04", "P4T2-N05", "P4T2-N06", "P4T2-N07", "P4T2-N08"],
      resourceIds: ["R-P4T2-01"],
      output: "四段式验收结论和修正后的职业表达"
    }
  },
  projects: [
    {
      ...
      status: "课程项目",
      tasks: [
        { id: "P1-T1", title: "任务1：室内环境信息采集", status: "学习任务", activity: "室内信息核验", output: "采集信息完整性记录" },
        { id: "P1-T2", title: "任务2：室外环境信息采集", status: "学习任务", activity: "室外场景信息整理", output: "室外环境采集清单" },
        { id: "P1-T3", title: "任务3：投诉信息采集", status: "学习任务", activity: "投诉线索分类", output: "投诉线索到验证对象的初步映射" }
      ]
    },
    {
      id: "P2",
      ...
      status: "重点项目",
      loopStatus: "测试数据形成证据链",
      tasks: [
        { id: "P2-T1", title: "任务1：DT/CQT测试准备和执行", status: "学习任务", activity: "确认测试任务、准备设备软件、执行DT/CQT并移交LOG", output: "测试数据交付包" },
        { id: "P2-T2", title: "任务2：5G网络测试问题处理", status: "条件任务", activity: "只在测试中断、定位异常、软件异常或数据不可用时进入", output: "异常处理记录与继续测试判断" },
        { id: "P2-T3", title: "任务3：5G网络测试数据分析", status: "拓展任务", activity: "导入LOG、读取指标、判断异常、归纳原因链并输出分析报告", output: "测试数据分析报告", deepCandidate: true }
      ]
    },
    {
      id: "P3",
      ...
      status: "课程项目",
      tasks: [
        { id: "P3-T1", title: "任务1：5G网管架构和功能", status: "学习任务", activity: "网管功能识别", output: "网管功能用途说明" },
        { id: "P3-T2", title: "任务2：5G网络运行监控", status: "学习任务", activity: "运行状态读表", output: "监控异常识别记录" },
        { id: "P3-T3", title: "任务3：5G网络参数检查", status: "学习任务", activity: "参数一致性检查", output: "参数异常清单" },
        { id: "P3-T4", title: "任务4：5G网络参数设置", status: "学习任务", activity: "参数设置记录", output: "参数设置记录" }
      ]
    },
    {
      id: "P4",
      ...
      status: "重点项目",
      loopStatus: "优化实施到结果验证",
      tasks: [
        { id: "P4-T1", title: "任务1：5G网络优化方案实施", status: "学习任务", activity: "确认优化对象、责任边界和复测入口", output: "优化实施记录与复测验证交接清单" },
        { id: "P4-T2", title: "任务2：5G网络优化结果验证", status: "重点学习任务", activity: "投诉归类、指标判断、依据分类、结论拼装", output: "四段式验收结论", deepSample: true },
        { id: "P4-T3", title: "任务3：5G网络优化报告输出", status: "学习任务", activity: "报告口径确认、证据链归集和结论边界修订", output: "优化报告输出样稿与沟通提纲" }
      ]
    },
    {
      id: "P5",
      ...
      status: "课程项目",
      tasks: [
        { id: "P5-T1", title: "任务1：5G全网性能指标采集", status: "学习任务", activity: "性能指标采集", output: "全网指标采集记录" },
        { id: "P5-T2", title: "任务2：5G全网性能提升实施", status: "学习任务", activity: "性能提升动作选择", output: "性能提升实施记录" },
        { id: "P5-T3", title: "任务3：5G全网性能提升验证", status: "学习任务", activity: "性能提升效果验证", output: "提升效果评价结论" }
      ]
    },
    {
      id: "P6",
      ...
      status: "课程项目",
      tasks: [
        { id: "P6-T1", title: "任务1：5G关键信令流程及解析", status: "学习任务", activity: "信令流程识读", output: "信令流程说明" },
        { id: "P6-T2", title: "任务2：5G信令问题分析及优化", status: "学习任务", activity: "信令问题定位", output: "信令问题分析结论" }
      ]
    }
  ],
  graph: {
    ...
    courseChain: [
      { id: "CG-01", label: "信息采集", project: "P1", status: "能力主链", desc: "收集投诉、环境、设备和测试前置信息。", next: "CG-02" },
      { id: "CG-02", label: "网络测试", project: "P2", status: "能力主链", desc: "完成DT/CQT测试、问题处理和测试数据分析。", next: "CG-03" },
      { id: "CG-03", label: "信息管理", project: "P3", status: "能力主链", desc: "整理网管、运行监控和参数信息。", next: "CG-04" },
      { id: "CG-04", label: "优化实施", project: "P4", status: "能力主链", desc: "实施优化方案，是结果验证的直接前置环节。", next: "CG-05" },
      { id: "CG-05", label: "结果验证", project: "P4", status: "重点能力", desc: "复核优化后是否达到目标，可进入P4-T2学习任务。", next: "CG-06" },
      { id: "CG-06", label: "性能提升", project: "P5", status: "能力主链", desc: "在验收基础上继续做全网性能提升。", next: "CG-07" },
      { id: "CG-07", label: "信令分析", project: "P6", status: "能力主链", desc: "面向复杂问题进行信令级分析和优化。", next: "" }
    ],
    detailNodes: [
  ...
  loops: {
    P2: {
      ...
      boundary: "P2-T1是正常主线入口，P2-T2只在测试异常或数据不可用时进入，P2-T3负责把可用数据组织成分析报告，为后续优化验证提供证据。",
      route: [
    ...
    P4: {
      ...
      boundary: "P4-T1说明优化实施依据，P4-T2完成结果验证学习，P4-T3把验证结论组织成报告表达。项目四呈现从实施到验收再到报告的完整学习路径。",
      route: [
        { id: "P4-T1", title: "5G网络优化方案实施", role: "实施入口", focus: "确认问题、依据、边界和复测入口。", output: "优化实施记录与复测验证交接清单" },
        { id: "P4-T2", title: "5G网络优化结果验证", role: "重点学习任务", focus: "判断哪些达标、哪些只是改善、哪些仍未闭环。", output: "四段式验收结论", deepSample: true },
  ...
  resources: [
    ...
    { id: "R-P4T2-01", title: "P4-T2学习任务页", type: "直接呈现页面", project: "P4", task: "P4-T2", node: "P4T2-N01-P4T2-N08", status: "学习任务页", audit: "学习闭环检查" },
    ...
    { id: "R-ALL-01", title: "全书媒体资源", type: "图片/截图", project: "全书", task: "多任务", node: "多节点", status: "媒体资源", audit: "媒体合规检查" },
    { id: "R-ALL-02", title: "课程能力图谱数据", type: "结构化数据", project: "全书", task: "18个任务", node: "CG-01-CG-07", status: "图谱数据", audit: "图谱一致性检查" }
  ],
  teacherSupport: [
    ...
    { title: "项目四带教", body: "P4-T1说明优化实施边界，P4-T2组织两课时结果验证学习，P4-T3讲评报告证据链和客户沟通边界。" },
    { title: "图谱使用方式", body: "完整图谱用于教师把握课程脉络；学生端优先看到与当前任务相关的局部路径。" },
    { title: "课堂验收", body: "教师重点观察学生能否从投诉、指标和依据形成可讲评的验收结论。" }
  ],
  publication: [
    { title: "资源包输出", state: "文字、表格、互动、图谱节点和教师材料可按资源包方式交付到出版社平台编辑。" },
    { title: "直接呈现挂接", state: "P4-T2学习任务可作为数字教材页面挂接到整书目录中，形成可阅读、可操作的任务学习页。" },
    { title: "版本追溯", state: "整书目录、任务页、资源、图谱节点和学习活动保留对应关系，便于后续更新。" },
    { title: "平台对接", state: "学习页、资源包和图谱数据可分别对应出版社平台的页面、素材、活动和统计接口。" },
    { title: "质量检查", state: "交付前检查内容正确性、媒体合规性、数据脱敏、页面可访问性和学习闭环完整性。" }
  ]
};
