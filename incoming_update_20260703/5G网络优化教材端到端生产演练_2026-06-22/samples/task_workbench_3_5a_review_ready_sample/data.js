window.P4T2_GRAPH_DRIVEN = {
  meta: {
    version: "3.5A",
    title: "5G网络优化结果验证",
    subtitle: "课程能力图谱驱动评审准备版",
    role: "网络优化助理工程师",
    bigQuestion: "怎样把投诉、指标和结论连成一次可靠的优化验收？",
    promise: "本版补强学习入口、完成标准、术语字典、二次修正和教师课堂组织工具，用于进入一线试看前评审。",
  ...
  learningEntry: {
    ...
    output: "做完要得到：一份“本次验收要看哪些数据”的初步判断。",
    standard: "完成标准：能说明每条投诉为什么对应覆盖、移动性、体验或容量中的一种。",
    finalOutput: "最终要形成：一段包含判断、依据、边界和建议的验收结论。"
  },
  lessonFlow: [
  ...
  teacher: {
    ...
    schedule: [
      { time: "0-5分钟", action: "投屏首屏学习入口，让学生说出本节课要交什么。", output: "学生能复述最终产出是验收结论。" },
      { time: "5-15分钟", action: "完成入门样例和对照样例A，教师追问为什么覆盖不是全部。", output: "形成投诉归类和验证流程。" },
      { time: "15-28分钟", action: "完成对照样例B和半扶手练习，板书能支持什么/不能说明什么。", output: "形成指标标注和依据分类。" },
      { time: "28-40分钟", action: "独立实践拼装结论，教师收集典型错误。", output: "形成可讲评结论。" },
      { time: "40-45分钟", action: "用模拟学情看板组织讲评，布置自学修订。", output: "明确课后改进方向。" }
    ],
    boardAdvice: [
    ...
    modeGuide: {
      class: [
        "课堂模式下，教师每完成一例就暂停一次，要求学生说明依据和边界。",
        "教师不要直接公布答案，先让学生在小组内说出“为什么”。",
        "最后一例用于讲评学生产出，不再重新讲概念。"
      ],
      self: [
        "自学模式可作为课后30分钟任务，要求学生完成至少3个案例和最终结论。",
        "学生提交前必须用术语字典检查不懂的指标。",
